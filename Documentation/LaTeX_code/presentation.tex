...
\begin{frame}{Setup}
  ...
  \begin{columns}
    \begin{column}{0.55\textwidth}
      ...
      \end{itemize}
      \textbf{Reference:} 
      \paragraph{The reference is a pure FEM method with a Dirichlet condition imposed on $\Gamma$ placed at $20L_y$}
    \end{column}
    \begin{column}{0.42\textwidth}
    \centering
    \vfill
...
\begin{frame}{FEM-BEM vs.\ Pure FEM}
  ...
  \begin{columns}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Documentation/runs/mesh_0050/margin_3/png/FEM_20_BEM_3.png}\\
      \small Pure FEM ($20\,L_y$ domain) — reference solution
    \end{column}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Documentation/runs/mesh_0050/margin_3/png/u_err_FEM_20_BEM_3.png}\\
...
\begin{frame}{Electric Field FEM-BEM}
  ...
  \begin{columns}
    \begin{column}{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{Documentation/runs/mesh_0050/margin_3/png/Efield.png}\\
