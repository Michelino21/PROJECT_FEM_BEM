...
\begin{frame}{Setup}
  ...
  \begin{columns}
    \begin{column}{0.55\textwidth}
      \textbf{Geometry:}
      \begin{itemize}
        \item $L_x = 0.10$ m, $L_y = 0.10$ m ($L_x/L_y = 1$)
      ...
      \end{itemize}
      \textbf{Reference:} 
      \paragraph{The reference is a pure FEM method with a Dirichlet condition imposed on $\Gamma$ placed at $100L_y$}
      \[
        C_{\text{pure\_FEM}} = ??? \text{ pF/m}
      \]
    \end{column}
    \begin{column}{0.42\textwidth}
        \centering
          ...
          \begin{tikzpicture}[scale=0.85]
            ...
            % Indicatore Lx (lunghezza piastra)
            \draw[<->,gray] (1,2.2)--(3,2.2)
              node[midway,above,font=\tiny]{$L_x$};
        
            % Indicatore Ly (distanza tra piastre / altezza caratteristica)
          ...
          \end{tikzpicture}
           ...
           \includegraphics[width=\linewidth]{Documentation/runs/mesh_0020/margin_10/png/FEM_10.png}\\
        \small Mesh Rapresentation
    \end{column}
...
\begin{frame}{Flux Through $\Gamma$ (FEM-BEM)}
  ...
  \begin{columns}
    ...
    \begin{column}{0.48\textwidth}
      ...
      \end{itemize}
      \[
        Q_{tot} =\oint_\Gamma \frac{\partial u}{\partial n}\,ds \approx -5.47\times10^{-13} \approx 0
      \]
      \vspace{-0.5em}
...
\begin{frame}{Surface Charge Density and Capacitance}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.44\textwidth}
      ... come calcolare capacità, solo con carica ...
    \end{column}
